...
doc_events = {
	...
	'Project':{
		...
		'after_insert': [
			'one_compliance.one_compliance.doc_events.project.create_commission_purchase_invoice',
			'one_compliance.one_compliance.doc_events.project.create_sales_order_after_project',
		],
	},
	'Customer':{
		'on_update':[
